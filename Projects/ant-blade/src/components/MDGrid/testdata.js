...
export const columnDefs = [
  { headerName: "Athlete", field: "athlete", width: 150, filter: 'text', filterParams: { apply: true } },
  { headerName: "Age", field: "age", width: 90, filter: 'number', filterParams: { apply: true } },
  { headerName: "Country", field: "country", width: 120, filterParams: { apply: true } },
  { headerName: "Year", field: "year", width: 90, filter: 'text', editable: true },
  { headerName: "Date", field: "date", width: 110 },
  { headerName: "Sport", field: "sport", width: 110, filter: 'text', cellStyle: { color: 'red' } },
  { headerName: "Gold", field: "gold", width: 100, filter: numberFilter, filterParams: { apply: true} },
